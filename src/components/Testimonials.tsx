...
const testimonials = [
	{
		...
		content:
			'Geo Nutrition supplements made my workout journey a whole lot easier!',
		rating: 5,
	...
	},
	{
		...
		role: 'Health Coach',
		content:
			'My clients absolutely love these supplements. Great quality and fast delivery.',
		rating: 5,
	...
	},
	{
		...
		content:
			'Premium supplements at reasonable prices. Cannot recommend enough!',
		rating: 5,
			...
			<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
				<div className='text-center mb-16'>
					...
					<p className='text-lg text-gray-600'>
						See what real people are saying about Geo Nutrition
					</p>
				</div>
						...
						<div className='flex items-center gap-4'>
							<div className='w-16 h-16 rounded-full bg-gray-200 overflow-hidden'>
								<Image
									...
									height={500} // or set based on your design
									className='w-full h-full object-cover'
									priority // optional – good if it’s above the fold
								/>
							</div>
							<div>
